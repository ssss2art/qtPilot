...
void TestComputerUseApi::testClick()
{
    ...
    bool clicked = false;
    connect(m_testButton, &QPushButton::clicked, this, [&clicked]() {
        clicked = true;
    });

    QJsonValue result = callResult("cu.click",
        QJsonObject{
            {"x", btnCenter.x()},
            {"y", btnCenter.y()}
        });
...
void TestComputerUseApi::testRightClick()
{
    ...
    QJsonValue result = callResult("cu.rightClick",
        QJsonObject{
            {"x", btnCenter.x()},
            {"y", btnCenter.y()}
        });
...
void TestComputerUseApi::testMiddleClick()
{
    ...
    QJsonValue result = callResult("cu.middleClick",
        QJsonObject{
            {"x", btnCenter.x()},
            {"y", btnCenter.y()}
        });
...
void TestComputerUseApi::testDoubleClick()
{
    ...
    QJsonValue result = callResult("cu.doubleClick",
        QJsonObject{
            {"x", btnCenter.x()},
            {"y", btnCenter.y()}
        });
...
{
    QJsonValue result = callResult("cu.mouseMove",
        QJsonObject{
            {"x", 100},
            {"y", 100}
        });
...
{
    QJsonValue result = callResult("cu.drag",
        QJsonObject{
            {"startX", 10},
            {"startY", 10},
            {"endX", 100},
...
void TestComputerUseApi::testMouseDown()
{
    ...
    QJsonValue result = callResult("cu.mouseDown",
        QJsonObject{
            {"x", btnCenter.x()},
            {"y", btnCenter.y()}
        });
...
void TestComputerUseApi::testMouseUp()
{
    ...
    QJsonValue result = callResult("cu.mouseUp",
        QJsonObject{
            {"x", btnCenter.x()},
            {"y", btnCenter.y()}
        });
...
void TestComputerUseApi::testType()
{
    ...
    QJsonValue result = callResult("cu.type",
...
void TestComputerUseApi::testKey()
{
    ...
    QJsonValue result1 = callResult("cu.key",
        QJsonObject{{"key", "ctrl+a"}});
    QApplication::processEvents();
    QVERIFY(result1.isObject());
    QCOMPARE(result1.toObject()["success"].toBool(), true);

    // Delete selected text
    QJsonValue result2 = callResult("cu.key",
        QJsonObject{{"key", "Delete"}});
    QApplication::processEvents();
...
void TestComputerUseApi::testKeyChromeNames()
{
    ...
    QJsonValue result3 = callResult("cu.key",
        QJsonObject{{"key", "ArrowUp"}});
...
void TestComputerUseApi::testScroll()
{
    ...
    QJsonValue result = callResult("cu.scroll",
        QJsonObject{
            {"x", 200},
            {"y", 150},
            {"direction", "down"},
...
{
    QJsonObject error = callExpectError("cu.click",
        QJsonObject{
            {"x", 9999},
            {"y", 9999}
        });
...
void TestComputerUseApi::testTypeNoFocusedWidget()
{
    ...
    QJsonObject error = callExpectError("cu.type",
        QJsonObject{{"text", "hello"}});
