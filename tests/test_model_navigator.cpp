...
void TestModelNavigator::testModelsInfoByModelId()
{
    ...
    QJsonValue result = callResult("qt.models.info",
...
{
    QJsonObject error = callExpectError("qt.models.info",
...
void TestModelNavigator::testModelsDataWithOffset()
{
    ...
    QJsonValue result = callResult("qt.models.data",
        QJsonObject{{"objectId", modelId}, {"offset", 1}, {"limit", 1}});
    QJsonObject data = result.toObject();
...
void TestModelNavigator::testModelsDataByRoleName()
{
    ...
    QJsonValue result = callResult("qt.models.data",
        QJsonObject{{"objectId", modelId}, {"roles", QJsonArray{"display"}}});
    QJsonObject data = result.toObject();
...
void TestModelNavigator::testModelsDataByRoleId()
{
    ...
    // Qt::DisplayRole == 0
    QJsonValue result = callResult("qt.models.data",
        QJsonObject{{"objectId", modelId}, {"roles", QJsonArray{0}}});
    QJsonObject data = result.toObject();
...
void TestModelNavigator::testModelsDataInvalidRole()
{
    ...
    QJsonObject error = callExpectError("qt.models.data",
        QJsonObject{{"objectId", modelId}, {"roles", QJsonArray{"nonexistent"}}});
...
void TestModelNavigator::testQmlInspectNonQmlObject()
{
    ...
    QJsonObject response = callRaw("qt.qml.inspect",
        QJsonObject{{"objectId", buttonId}});
...
{
    QJsonObject error = callExpectError("qt.qml.inspect",
        QJsonObject{{"objectId", "nonexistent/path/xyz"}});
...
void TestModelNavigator::testResponseEnvelopeWrapping()
{
    ...
    QJsonObject envelope = callEnvelope("qt.models.info",
        QJsonObject{{"objectId", modelId}});
