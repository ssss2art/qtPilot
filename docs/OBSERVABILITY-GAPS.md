...
| `feat/interaction-enhancements` *(epic)* | ~~T3 mouse modifiers~~ ✅, T4 hover, T5 multi-select, T6 menus, T7 diff, T8 DPR, T9 focus, T11 multi-chord, T12 held keys | ⏳ planned — T3 shipped separately on `feature/input-modifiers` |
